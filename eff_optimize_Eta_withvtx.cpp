{
	...
	PATH_samples_ZMM14TeV = "/xrootd/store/user/tt8888tt/muon/";//KISTI
	...
	TString Cut_base;
	TString ZMM_Sig_Trk_Tight_Cut, ZMM_Sig_Trk_Loose_Cut;
	TString ZMM_Sig_PF_Tight_Cut, ZMM_Sig_PF_Loose_Cut;
	TString ZMM_Sig_PF_Tight_Cut140, ZMM_Sig_PF_Loose_Cut140;
	TString ZMM_Sig_PF_Tight_Cut200, ZMM_Sig_Trk_Loose_Cut200;

	TString QCD_Sig_Trk_Tight_Cut, QCD_Sig_Trk_Loose_Cut;
	TString QCD_Sig_PF_Tight_Cut, QCD_Sig_PF_Loose_Cut;
	TString QCD_Sig_PF_Tight_Cut140, QCD_Sig_PF_Loose_Cut140;
	TString QCD_Sig_PF_Tight_Cut200, QCD_Sig_Trk_Loose_Cut200;
	...
	TString Vertex_Cut, signal_Cut;
	Vertex_Cut = " && abs(recoMuon_poszPV0-recoMuon_poszSimPV) < 0.5";
	signal_Cut = " && recoMuon_signal!=1";
	...
	PF_Loose_Cut140 = Cut_base+Form(" && recoMuon_isLoose==1 && recoMuon_PFIsolation04 < 1.008");
	...
	ZMM_Sig_Trk_Tight_Cut = Trk_Tight_Cut+Vertex_Cut;
	ZMM_Sig_Trk_Loose_Cut = Trk_Loose_Cut+Vertex_Cut;
	ZMM_Sig_PF_Tight_Cut = PF_Tight_Cut+Vertex_Cut;
	ZMM_Sig_PF_Loose_Cut = PF_Loose_Cut+Vertex_Cut;
	ZMM_Sig_PF_Tight_Cut140 = PF_Tight_Cut140+Vertex_Cut;
	ZMM_Sig_PF_Loose_Cut140 = PF_Loose_Cut140+Vertex_Cut;
	ZMM_Sig_PF_Tight_Cut200 = PF_Tight_Cut200+Vertex_Cut;
	ZMM_Sig_PF_Loose_Cut200 = PF_Loose_Cut200+Vertex_Cut;

	Bkg_Cut = Cut_base+Vertex_Cut;

	QCD_Sig_Trk_Tight_Cut = Trk_Tight_Cut+Vertex_Cut+signal_Cut;
	QCD_Sig_Trk_Loose_Cut = Trk_Loose_Cut+Vertex_Cut+signal_Cut;
	QCD_Sig_PF_Tight_Cut = PF_Tight_Cut+Vertex_Cut+signal_Cut;
	QCD_Sig_PF_Loose_Cut = PF_Loose_Cut+Vertex_Cut+signal_Cut;
	QCD_Sig_PF_Tight_Cut140 = PF_Tight_Cut140+Vertex_Cut+signal_Cut;
	QCD_Sig_PF_Loose_Cut140 = PF_Loose_Cut140+Vertex_Cut+signal_Cut;
	QCD_Sig_PF_Tight_Cut200 = PF_Tight_Cut200+Vertex_Cut+signal_Cut;
	QCD_Sig_PF_Loose_Cut200 = PF_Loose_Cut200+Vertex_Cut+signal_Cut;
	...
	for(int Iso=0; Iso<ISOCut; Iso++){
		for(int ID=0; ID<IDCut; ID++){
			...
			if(Iso==0 && ID==0  )recottree->Project(Form("histo_Sig1%d_%d",Iso,ID),"recoMuon.Eta()",ZMM_Sig_Trk_Tight_Cut);
			if(Iso==0 && ID==1  )recottree->Project(Form("histo_Sig1%d_%d",Iso,ID),"recoMuon.Eta()",ZMM_Sig_Trk_Loose_Cut);
			if(Iso==1 && ID==0  )recottree->Project(Form("histo_Sig1%d_%d",Iso,ID),"recoMuon.Eta()",ZMM_Sig_PF_Tight_Cut);
			if(Iso==1 && ID==1  )recottree->Project(Form("histo_Sig1%d_%d",Iso,ID),"recoMuon.Eta()",ZMM_Sig_PF_Loose_Cut);

			histo_Back1[Iso][ID] = new TH1F(Form("histo_Back1%d_%d",Iso,ID),Form(""),nbin_eff,xmin_eff,xmax_eff);
			histo_Back1[Iso][ID]->Sumw2();

			if(Iso==0 && ID==0  )recottree->Project(Form("histo_Back1%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==0 && ID==1  )recottree->Project(Form("histo_Back1%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==1 && ID==0  )recottree->Project(Form("histo_Back1%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==1 && ID==1  )recottree->Project(Form("histo_Back1%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			...
			if(Iso==0 && ID==0  )recottree_140->Project(Form("histo_Sig2%d_%d",Iso,ID),"recoMuon.Eta()",ZMM_Sig_Trk_Tight_Cut);
			if(Iso==0 && ID==1  )recottree_140->Project(Form("histo_Sig2%d_%d",Iso,ID),"recoMuon.Eta()",ZMM_Sig_Trk_Loose_Cut);
			if(Iso==1 && ID==0  )recottree_140->Project(Form("histo_Sig2%d_%d",Iso,ID),"recoMuon.Eta()",ZMM_Sig_PF_Tight_Cut140);
			if(Iso==1 && ID==1  )recottree_140->Project(Form("histo_Sig2%d_%d",Iso,ID),"recoMuon.Eta()",ZMM_Sig_PF_Loose_Cut140);

			histo_Back2[Iso][ID] = new TH1F(Form("histo_Back2%d_%d",Iso,ID),Form(""),nbin_eff,xmin_eff,xmax_eff);
			histo_Back2[Iso][ID]->Sumw2();

			if(Iso==0 && ID==0  )recottree_140->Project(Form("histo_Back2%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==0 && ID==1  )recottree_140->Project(Form("histo_Back2%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==1 && ID==0  )recottree_140->Project(Form("histo_Back2%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==1 && ID==1  )recottree_140->Project(Form("histo_Back2%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			...
			if(Iso==0 && ID==0  )recottree_200->Project(Form("histo_Sig3%d_%d",Iso,ID),"recoMuon.Eta()",ZMM_Sig_Trk_Tight_Cut);
			if(Iso==0 && ID==1  )recottree_200->Project(Form("histo_Sig3%d_%d",Iso,ID),"recoMuon.Eta()",ZMM_Sig_Trk_Loose_Cut);
			if(Iso==1 && ID==0  )recottree_200->Project(Form("histo_Sig3%d_%d",Iso,ID),"recoMuon.Eta()",ZMM_Sig_PF_Tight_Cut200);
			if(Iso==1 && ID==1  )recottree_200->Project(Form("histo_Sig3%d_%d",Iso,ID),"recoMuon.Eta()",ZMM_Sig_PF_Loose_Cut200);

			histo_Back3[Iso][ID] = new TH1F(Form("histo_Back3%d_%d",Iso,ID),Form(""),nbin_eff,xmin_eff,xmax_eff);
			histo_Back3[Iso][ID]->Sumw2();

			if(Iso==0 && ID==0  )recottree_200->Project(Form("histo_Back3%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==0 && ID==1  )recottree_200->Project(Form("histo_Back3%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==1 && ID==0  )recottree_200->Project(Form("histo_Back3%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==1 && ID==1  )recottree_200->Project(Form("histo_Back3%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);

			//-----------------------------------------------------
			histo_Sig4[Iso][ID] = new TH1F(Form("histo_Sig4%d_%d",Iso,ID),Form(""),nbin_eff,xmin_eff,xmax_eff);
			histo_Sig4[Iso][ID]->Sumw2();

			if(Iso==0 && ID==0  )recottree_QCD->Project(Form("histo_Sig4%d_%d",Iso,ID),"recoMuon.Eta()",QCD_Sig_Trk_Tight_Cut);
			if(Iso==0 && ID==1  )recottree_QCD->Project(Form("histo_Sig4%d_%d",Iso,ID),"recoMuon.Eta()",QCD_Sig_Trk_Loose_Cut);
			if(Iso==1 && ID==0  )recottree_QCD->Project(Form("histo_Sig4%d_%d",Iso,ID),"recoMuon.Eta()",QCD_Sig_PF_Tight_Cut);
			if(Iso==1 && ID==1  )recottree_QCD->Project(Form("histo_Sig4%d_%d",Iso,ID),"recoMuon.Eta()",QCD_Sig_PF_Loose_Cut);

			histo_Back4[Iso][ID] = new TH1F(Form("histo_Back4%d_%d",Iso,ID),Form(""),nbin_eff,xmin_eff,xmax_eff);
			histo_Back4[Iso][ID]->Sumw2();

			if(Iso==0 && ID==0  )recottree_QCD->Project(Form("histo_Back4%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==0 && ID==1  )recottree_QCD->Project(Form("histo_Back4%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==1 && ID==0  )recottree_QCD->Project(Form("histo_Back4%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==1 && ID==1  )recottree_QCD->Project(Form("histo_Back4%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			...
			if(Iso==0 && ID==0  )recottree_QCD140->Project(Form("histo_Sig5%d_%d",Iso,ID),"recoMuon.Eta()",QCD_Sig_Trk_Tight_Cut);
			if(Iso==0 && ID==1  )recottree_QCD140->Project(Form("histo_Sig5%d_%d",Iso,ID),"recoMuon.Eta()",QCD_Sig_Trk_Loose_Cut);
			if(Iso==1 && ID==0  )recottree_QCD140->Project(Form("histo_Sig5%d_%d",Iso,ID),"recoMuon.Eta()",QCD_Sig_PF_Tight_Cut140);
			if(Iso==1 && ID==1  )recottree_QCD140->Project(Form("histo_Sig5%d_%d",Iso,ID),"recoMuon.Eta()",QCD_Sig_PF_Loose_Cut140);

			histo_Back5[Iso][ID] = new TH1F(Form("histo_Back5%d_%d",Iso,ID),Form(""),nbin_eff,xmin_eff,xmax_eff);
			histo_Back5[Iso][ID]->Sumw2();

			if(Iso==0 && ID==0  )recottree_QCD140->Project(Form("histo_Back5%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==0 && ID==1  )recottree_QCD140->Project(Form("histo_Back5%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==1 && ID==0  )recottree_QCD140->Project(Form("histo_Back5%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==1 && ID==1  )recottree_QCD140->Project(Form("histo_Back5%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);

			//------------------------------------------------------------------------------------------------
			histo_Sig6[Iso][ID] = new TH1F(Form("histo_Sig6%d_%d",Iso,ID),Form(""),nbin_eff,xmin_eff,xmax_eff);
			histo_Sig6[Iso][ID]->Sumw2();

			if(Iso==0 && ID==0  )recottree_QCD200->Project(Form("histo_Sig6%d_%d",Iso,ID),"recoMuon.Eta()",QCD_Sig_Trk_Tight_Cut);
			if(Iso==0 && ID==1  )recottree_QCD200->Project(Form("histo_Sig6%d_%d",Iso,ID),"recoMuon.Eta()",QCD_Sig_Trk_Loose_Cut);
			if(Iso==1 && ID==0  )recottree_QCD200->Project(Form("histo_Sig6%d_%d",Iso,ID),"recoMuon.Eta()",QCD_Sig_PF_Tight_Cut200);
			if(Iso==1 && ID==1  )recottree_QCD200->Project(Form("histo_Sig6%d_%d",Iso,ID),"recoMuon.Eta()",QCD_Sig_PF_Loose_Cut200);

			histo_Back6[Iso][ID] = new TH1F(Form("histo_Back6%d_%d",Iso,ID),Form(""),nbin_eff,xmin_eff,xmax_eff);
			histo_Back6[Iso][ID]->Sumw2();

			if(Iso==0 && ID==0  )recottree_QCD200->Project(Form("histo_Back6%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==0 && ID==1  )recottree_QCD200->Project(Form("histo_Back6%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==1 && ID==0  )recottree_QCD200->Project(Form("histo_Back6%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			if(Iso==1 && ID==1  )recottree_QCD200->Project(Form("histo_Back6%d_%d",Iso,ID),"recoMuon.Eta()",Bkg_Cut);
			...
			histo_Eff1[Iso][ID]->GetXaxis()->SetTitle("#mu #eta");
			...
			//-------------------------------------------------------------------
			l_[Iso][ID]->AddEntry(histo_Eff1[Iso][ID],"Phase II ZMM_Sig PU0", "p");
			l_[Iso][ID]->AddEntry(histo_Eff2[Iso][ID],"Phase II ZMM_Sig PU140", "p");
			l_[Iso][ID]->AddEntry(histo_Eff3[Iso][ID],"Phase II ZMM_Sig PU200", "p");
			l_[Iso][ID]->AddEntry(histo_Eff4[Iso][ID],"Phase II ZMM_Bkg QCD0", "p");
			l_[Iso][ID]->AddEntry(histo_Eff5[Iso][ID],"Phase II ZMM_Bkg QCD140", "p");
			l_[Iso][ID]->AddEntry(histo_Eff6[Iso][ID],"Phase II ZMM_Bkg QCD200", "p");
			...
			if(Iso==0 && ID==0  )canvIso_[Iso][ID]->Print(ZMM_Sig_Trk_Tight_Cut+Form(" && Trk03 && Pt>%dGeV && eta>%1.1f,Eta Eff",hEff_pt[ID],hEff_eta[ID])+".png");
			if(Iso==0 && ID==1  )canvIso_[Iso][ID]->Print(ZMM_Sig_Trk_Loose_Cut+Form(" && Trk03 && Pt>%dGev && eta>%1.1f,Eta Eff",hEff_pt[ID],hEff_eta[ID])+".png");
			if(Iso==1 && ID==0  )canvIso_[Iso][ID]->Print(ZMM_Sig_PF_Tight_Cut+Form(" && PF04 && Pt>%dGev && eta>%1.1f,Eta Eff",hEff_pt[ID],hEff_eta[ID])+".png");
			if(Iso==1 && ID==1  )canvIso_[Iso][ID]->Print(ZMM_Sig_PF_Loose_Cut+Form(" && PF04 && Pt>%dGev && eta>%1.1f,Eta Eff",hEff_pt[ID],hEff_eta[ID])+".png");
		}
	}
	cout<<"14 TeV"<<endl;
}
