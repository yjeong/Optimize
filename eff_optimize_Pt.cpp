{
	...
	TString Background_Trk_Tight_Cut, Background_Trk_Loose_Cut;
        TString Background_PF_Tight_Cut, Background_PF_Loose_Cut;
        TString Background_PF_Tight_Cut140, Background_PF_Loose_Cut140;
        TString Background_PF_Tight_Cut200, Background_Trk_Loose_Cut200;
	...
	Background_Trk_Tight_Cut = Trk_Tight_Cut+Form("&& recoMuon_signal==0");
        Background_Trk_Loose_Cut = Trk_Loose_Cut+Form("&& recoMuon_signal==0");
        Background_PF_Tight_Cut = PF_Tight_Cut+Form("&& recoMuon_signal==0");
        Background_PF_Loose_Cut = PF_Loose_Cut+Form("&& recoMuon_signal==0");
        Background_PF_Tight_Cut140 = PF_Tight_Cut140+Form("&& recoMuon_signal==0");
        Background_PF_Loose_Cut140 = PF_Loose_Cut140+Form("&& recoMuon_signal==0");
        Background_PF_Tight_Cut200 = PF_Tight_Cut200+Form("&& recoMuon_signal==0");
        Background_PF_Loose_Cut200 = PF_Loose_Cut200+Form("&& recoMuon_signal==0");
	...
	for(int Iso=0; Iso<ISOCut; Iso++){
		for(int ID=0; ID<IDCut; ID++){
			...
			if(Iso==0 && ID==0  )recottree_QCD->Project(Form("histo_Sig4%d_%d",Iso,ID),"recoMuon.Pt()",Background_Trk_Tight_Cut);
			if(Iso==0 && ID==1  )recottree_QCD->Project(Form("histo_Sig4%d_%d",Iso,ID),"recoMuon.Pt()",Background_Trk_Loose_Cut);
			if(Iso==1 && ID==0  )recottree_QCD->Project(Form("histo_Sig4%d_%d",Iso,ID),"recoMuon.Pt()",Background_PF_Tight_Cut);
			if(Iso==1 && ID==1  )recottree_QCD->Project(Form("histo_Sig4%d_%d",Iso,ID),"recoMuon.Pt()",Background_PF_Loose_Cut);
			...
			histo_Sig5[Iso][ID] = new TH1F(Form("histo_Sig5%d_%d",Iso,ID),Form(""),nbin_eff,xmin_eff,xmax_eff);
                        ...
                        if(Iso==0 && ID==0  )recottree_QCD140->Project(Form("histo_Sig5%d_%d",Iso,ID),"recoMuon.Pt()",Background_Trk_Tight_Cut);
                        if(Iso==0 && ID==1  )recottree_QCD140->Project(Form("histo_Sig5%d_%d",Iso,ID),"recoMuon.Pt()",Background_Trk_Loose_Cut);
                        if(Iso==1 && ID==0  )recottree_QCD140->Project(Form("histo_Sig5%d_%d",Iso,ID),"recoMuon.Pt()",Background_PF_Tight_Cut140);
                        if(Iso==1 && ID==1  )recottree_QCD140->Project(Form("histo_Sig5%d_%d",Iso,ID),"recoMuon.Pt()",Background_PF_Loose_Cut140);
			...
			if(Iso==0 && ID==0  )recottree_QCD200->Project(Form("histo_Sig6%d_%d",Iso,ID),"recoMuon.Pt()",Background_Trk_Tight_Cut);
			if(Iso==0 && ID==1  )recottree_QCD200->Project(Form("histo_Sig6%d_%d",Iso,ID),"recoMuon.Pt()",Background_Trk_Loose_Cut);
			if(Iso==1 && ID==0  )recottree_QCD200->Project(Form("histo_Sig6%d_%d",Iso,ID),"recoMuon.Pt()",Background_PF_Tight_Cut200);
			if(Iso==1 && ID==1  )recottree_QCD200->Project(Form("histo_Sig6%d_%d",Iso,ID),"recoMuon.Pt()",Background_PF_Loose_Cut200);
			...
			l_[Iso][ID]->AddEntry(histo_Eff4[Iso][ID],"Phase II Background QCD0", "p");
			l_[Iso][ID]->AddEntry(histo_Eff5[Iso][ID],"Phase II Background QCD140", "p");
			l_[Iso][ID]->AddEntry(histo_Eff6[Iso][ID],"Phase II Background QCD200", "p");
			...
			if(Iso==0 && ID==0  )canvIso_[Iso][ID]->Print(Signal_PF_Tight_Cut+Form(" && Trk03 && Pt>%dGeV && eta>%1.1f,Pt Eff",hEff_pt[ID],hEff_eta[ID])+".png");
			if(Iso==0 && ID==1  )canvIso_[Iso][ID]->Print(Signal_PF_Loose_Cut+Form(" && Trk03 && Pt>%dGev && eta>%1.1f,Pt Eff",hEff_pt[ID],hEff_eta[ID])+".png");
			if(Iso==1 && ID==0  )canvIso_[Iso][ID]->Print(Trk_Tight_Cut+Form(" && PF04 && Pt>%dGev && eta>%1.1f,Pt Eff",hEff_pt[ID],hEff_eta[ID])+".png");
			if(Iso==1 && ID==1  )canvIso_[Iso][ID]->Print(Trk_Loose_Cut+Form(" && PF04 && Pt>%dGev && eta>%1.1f,Pt Eff",hEff_pt[ID],hEff_eta[ID])+".png");
		}
	}
	cout<<"14 TeV"<<endl;
}
