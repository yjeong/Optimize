{
	...
	for(int Iso=0; Iso<ISOCut; Iso++){
		for(int ID=0; ID<IDCut; ID++){
			...
			if(Iso==0 && ID==0  )recottree->Project(Form("histo_Sig1%d_%d",Iso,ID),"recoMuon.Pt()",Trk_Tight_Cut);
			if(Iso==0 && ID==1  )recottree->Project(Form("histo_Sig1%d_%d",Iso,ID),"recoMuon.Pt()",Trk_Loose_Cut);
			if(Iso==1 && ID==0  )recottree->Project(Form("histo_Sig1%d_%d",Iso,ID),"recoMuon.Pt()",PF_Tight_Cut);
			if(Iso==1 && ID==1  )recottree->Project(Form("histo_Sig1%d_%d",Iso,ID),"recoMuon.Pt()",PF_Loose_Cut);
			...
			if(Iso==0 && ID==0  )recottree_140->Project(Form("histo_Sig2%d_%d",Iso,ID),"recoMuon.Pt()",Trk_Tight_Cut);
			if(Iso==0 && ID==1  )recottree_140->Project(Form("histo_Sig2%d_%d",Iso,ID),"recoMuon.Pt()",Trk_Loose_Cut);
			if(Iso==1 && ID==0  )recottree_140->Project(Form("histo_Sig2%d_%d",Iso,ID),"recoMuon.Pt()",PF_Tight_Cut140);
			if(Iso==1 && ID==1  )recottree_140->Project(Form("histo_Sig2%d_%d",Iso,ID),"recoMuon.Pt()",PF_Loose_Cut140);
			...
			if(Iso==0 && ID==0  )recottree_200->Project(Form("histo_Sig3%d_%d",Iso,ID),"recoMuon.Pt()",Trk_Tight_Cut);
			if(Iso==0 && ID==1  )recottree_200->Project(Form("histo_Sig3%d_%d",Iso,ID),"recoMuon.Pt()",Trk_Loose_Cut);
			if(Iso==1 && ID==0  )recottree_200->Project(Form("histo_Sig3%d_%d",Iso,ID),"recoMuon.Pt()",PF_Tight_Cut200);
			if(Iso==1 && ID==1  )recottree_200->Project(Form("histo_Sig3%d_%d",Iso,ID),"recoMuon.Pt()",PF_Loose_Cut200);
			...
			if(Iso==0 && ID==0  )canvIso_[Iso][ID]->Print(Trk_Tight_Cut+Form(" && Trk03 && Pt>%dGeV && eta>%1.1f,Pt Eff",hEff_pt[ID],hEff_eta[ID])+".png");
			if(Iso==0 && ID==1  )canvIso_[Iso][ID]->Print(Trk_Loose_Cut+Form(" && Trk03 && Pt>%dGev && eta>%1.1f,Pt Eff",hEff_pt[ID],hEff_eta[ID])+".png");
			if(Iso==1 && ID==0  )canvIso_[Iso][ID]->Print(PF_Tight_Cut+Form(" && PF04 && Pt>%dGev && eta>%1.1f,Pt Eff",hEff_pt[ID],hEff_eta[ID])+".png");
			if(Iso==1 && ID==1  )canvIso_[Iso][ID]->Print(PF_Loose_Cut+Form(" && PF04 && Pt>%dGev && eta>%1.1f,Pt Eff",hEff_pt[ID],hEff_eta[ID])+".png");
		}
	}
	cout<<"14 TeV"<<endl;
}
